    ...
    function Footable(t, o, id) {
        ...
        ft.resize = function () {            
            ...
            var info = {
                ...
                'viewportWidth': $table.width(),   //the width of the viewport
                'viewportHeight': $table.width(), //the width of the viewport
                'orientation': null
            };
            ...
            if (!pinfo || ((pinfo && pinfo.width && pinfo.width != info.width) || (pinfo && pinfo.height && pinfo.height != info.height))) {
                ...
                var empx = getComputedStyle(ft.table, "").fontSize;
                empx = empx.substring(0, empx.length - 2);
                for (var i = 0; i < ft.breakpoints.length; i++) {
                    breakpoint = ft.breakpoints[i];
                    if (breakpoint && breakpoint.width && info.width <= (breakpoint.width*empx)) {
                        current = breakpoint;
                        break;
                    }
                }
